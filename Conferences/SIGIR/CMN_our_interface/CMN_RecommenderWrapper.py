    ...
    def _run_epoch_CMN(self, currentEpoch):
        ...
        for k, example in progress:
            ...
            feed = {
                ...
                self.model.input_positive_items_popularity: settings.Settings.popularity[ratings[:, 1]],
            ...
            if verbose:
                ...
                print('Luciano > users (self.model.input_users):\n', ratings[:, 0])
                print('Luciano > positive items (self.model.input_items):\n', ratings[:, 1])
                print('Luciano > negative items (self.model.input_items_negative):\n', ratings[:, 2])
    ...
    def _run_epoch_GMF(self, currentEpoch):
        ...
        for k, example in progress:
            feed = {
                ...
                self.model.input_positive_items_popularity: settings.Settings.popularity[example[:, 1]],
