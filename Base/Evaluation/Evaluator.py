...
class EvaluatorMetrics(Enum):
    ...
    LOG_WEIGHTED_HIT_RATE = "LOG_WEIGHTED_HIT_RATE"
...
class EvaluatorHoldout(Evaluator):
    ...
    def _run_evaluation_on_selected_users(self, recommender_object, usersToEvaluate, block_size=1):
        ...
        while user_batch_start < len(self.usersToEvaluate):
            ...
            # print('user_batch_start:', user_batch_start)
            ...
            # print('recommended recommended_items_batch_list:', recommended_items_batch_list)
            ...
            for batch_user_index in range(len(recommended_items_batch_list)):
                ...
                if verbose and test_user % 1 == 0:
                    if number_of_guessed_items > 0:
                        ...
                        print('recommended_items:', recommended_items_batch_list[batch_user_index])
                        print('is_relevant:', np.in1d(recommended_items, relevant_items, assume_unique=True))
                        print('number_of_guessed_items:', number_of_guessed_items)
                        print('============================================================')
                    else:
                        print('Test =======================================================')
                        print('The recommender did not find any preferred item!')
                        print('user:', test_user)
                        print('relevant items:', relevant_items)
                        print('============================================================')
